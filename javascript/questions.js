...
const questions = [
...

  {
    ...
    questions: [
      ...
      {
        question: "Which animated movie features a young fish named Nemo?",
        options: [
          "Finding Dory",
          "Shark Tale",
          "Finding Nemo",
      ...
      {
        question:
          "Which popular music video features the song 'Thriller' by Michael Jackson?",
        options: ["Beat It", "Bad", "Smooth Criminal", "Thriller"],
        correctAnswer: 3,
      },
      {
      ...
      {
        question:
          "Which actor played Jack Sparrow in 'Pirates of the Caribbean'?",
        options: ["Johnny Depp", "Orlando Bloom", "Tom Hanks", "Brad Pitt"],
        correctAnswer: 0,
      },
      {
        question: "Which film won the Academy Award for Best Picture in 2018?",
        options: ["The Shape of Water", "La La Land", "Moonlight", "Birdman"],
        correctAnswer: 0,
      },
      {
        question: "Who won the Academy Award for Best Actress in 2018?",
        options: [
          "Frances McDormand",
          "Meryl Streep",
          "Emma Stone",
      ...
      {
        question: "Which artist released the album 'Purpose' in 2015?",
        options: ["Justin Bieber", "Ed Sheeran", "Drake", "Ariana Grande"],
        correctAnswer: 0,
      },
      {
      ...
      {
        question:
          "Which TV series features the characters of Eleven and Mike Wheeler?",
        options: ["Stranger Things", "Dark", "The Walking Dead", "Westworld"],
        correctAnswer: 0,
      },
      {
        question: "Who sang the hit song 'Uptown Funk'?",
        options: [
          "Bruno Mars",
          "Ed Sheeran",
          "Justin Timberlake",
      ...
      {
        question: "Which film won the Academy Award for Best Picture in 2017?",
        options: ["La La Land", "Moonlight", "The Revenant", "Spotlight"],
        correctAnswer: 1,
      },
      {
        question: "Which character does Tom Hanks play in 'Forrest Gump'?",
        options: ["Captain Miller", "Forrest Gump", "Chuck Noland", "Big"],
        correctAnswer: 1,
      },
    ],
  },
